        ...
        <section className={styles.about} id='About'>
            <div>
                ...
                <p>
                    ...
                    <br /><br />
                    Besides spending my time on coding, I love to play chess and follow chess sports scene, go for long, late-night walks and play competetive computer games.

                </p>
            </div>
            <img src={myImage} className={styles.myImg} width={350} />
        </section>
    );
}